"""Formal frozen-model evidence capture for HoloGrip.
...
VALIDATION_ROOT = PACKAGE_ROOT / "Data" / "Validation"
...
class ValidationRecorder:
    ...
    def start(self, name: str, model_path: Path, model_sha: str) -> Path:
        ...
        manifest = {
            ...
            "purpose": "Frozen-model raw-only new-player/new-song validation",
            ...
            "notes": ["MIDI is not used by inference.", "This GUI owns both COM ports and records raw 100 Hz.", "Official score is recomputed offline from saved raw_100hz.csv before MIDI is read."],
        }
