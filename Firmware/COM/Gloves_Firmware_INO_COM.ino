/**
 * HoloGrip wired collection firmware.
 *
 * Flash this sketch once for each glove. Set HAND_ID to 'R' for the right
 * glove and 'L' for the left glove. The Python COM collector reads the same
 * D,... packet format as the UDP firmware, at 100 Hz over USB serial.
 */

#include <Wire.h>
#include <math.h>

// Change this before flashing the second glove.
#define HAND_ID 'R'
