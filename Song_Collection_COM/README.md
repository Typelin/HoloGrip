...
New raw CSV files are written to `CSV_Data/Song_Collection_COM/`.

The old `UDP_version_release` entry remains for the legacy Wi-Fi/UDP workflow.
...
`Derived_Data/Song_Collection_COM/`.
